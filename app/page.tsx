        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-8 md:mb-0 text-center md:text-left">
              <h1 className="text-4xl md:text-5xl font-bold mb-2">Janmejaya Das</h1>
              <h2 className="text-xl md:text-2xl font-light">Senior Software Engineer</h2>
              <div className="mt-6">
                <p className="text-blue-100 mb-4 max-w-xl">
                  Dynamic Full-Stack Software Engineer with 12 years of experience in backend
                  technologies, cloud migrations, and system optimizations. Currently enhancing
                  enterprise-level solutions at Microsoft.
                </p>
                <div className="flex flex-wrap justify-center md:justify-start gap-3 mt-4">
                  <a href="mailto:janmejaya.das1@gmail.com" className="bg-white text-blue-800 px-4 py-2 rounded-full text-sm font-medium hover:bg-blue-100 transition">
                    Email Me
                  </a>
                  <a href="https://github.com/janmejaya-das" target="_blank" rel="noopener noreferrer" className="bg-white text-blue-800 px-4 py-2 rounded-full text-sm font-medium hover:bg-blue-100 transition">
                    GitHub
                  </a>
                  <a href="https://linkedin.com/in/janmejaya-das" target="_blank" rel="noopener noreferrer" className="bg-white text-blue-800 px-4 py-2 rounded-full text-sm font-medium hover:bg-blue-100 transition">
                    LinkedIn
                  </a>
                </div>
              </div>
            </div>
            <div className="w-48 h-48 md:w-56 md:h-56 bg-blue-900 rounded-full overflow-hidden border-4 border-white shadow-xl">
